...
$(function() {
    ...
    function jqI18nProperties(navLanguage) {
        jQuery.i18n.properties({
            ...
            callback: function() { //Set display contents after successful loading
                ...
                $('.Plan-p8').html($.i18n.prop('Plan p8'));
                $('.Plan-p9').html($.i18n.prop('Plan p9'));
                ...
                $('.Roadmap-p15-1').html($.i18n.prop('Roadmap p15-1'));
                $('.Roadmap-p15-2').html($.i18n.prop('Roadmap p15-2'));
                $('.Roadmap-p15-3').html($.i18n.prop('Roadmap p15-3'));
                $('.Roadmap-p15-4').html($.i18n.prop('Roadmap p15-4'));
                ...
                $('.Roadmap-p19-1').html($.i18n.prop('Roadmap p19-1'));
                $('.Roadmap-p19-2').html($.i18n.prop('Roadmap p19-2'));
                $('.Roadmap-p19-3').html($.i18n.prop('Roadmap p19-3'));
                $('.Roadmap-p19-4').html($.i18n.prop('Roadmap p19-4'));
                $('.Roadmap-p19-5').html($.i18n.prop('Roadmap p19-5'));
    ...
    navLanguage == 'zh' ? $('.white-paper').attr('href', 'https://docsend.com/view/adi48ic') : $('.white-paper').attr('href', 'https://docsend.com/view/3vv23qu');
